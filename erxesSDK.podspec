#
# Be sure to run `pod lib lint erxesSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'erxesSDK'
  s.version          = '0.1.0'
  s.summary          = 'A short description of erxesSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'git@github.com:Munkhorgilb/erxes-iOS-SDK.git', :tag => s.version.to_s }
