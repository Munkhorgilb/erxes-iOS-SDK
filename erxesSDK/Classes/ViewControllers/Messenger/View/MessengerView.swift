...
//        field.borderStyle = UITextField.BorderStyle.roundedRect
        ...
        if let showVideoCall = messengerData?.showVideoCallRequest, showVideoCall == true {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collection.register(CollectionHeader.self, forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: "CollectionHeader")
        collection.register(CollectionFooter.self, forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: "CollectionFooter")
